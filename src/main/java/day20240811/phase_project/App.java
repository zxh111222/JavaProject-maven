package day20240811.phase_project;

import day20240811.phase_project.downloader.Downloader;
import day20240811.phase_project.dto.CustomResult;
import day20240811.phase_project.notificator.Notificator;
import day20240811.phase_project.parser.Parser;
import day20240811.phase_project.storage.Storage;
...
//        System.out.println("配置文件读取成功!");
    ...
    private static Properties loadFromConfiguration() {
        Properties properties = new Properties();
        String fileName = "src/main/java/day20240811/phase_project/resources/config_local.properties";
        try {
